...
<img src="{{ site.baseurl }}/assets/images/dc_motor.jpg" alt="Image of the DC motor" style="
	margin-right: auto;
	margin-left: auto;
	width: 50%;
	"
...
<img src="{{ site.baseurl }}/assets/images/motor_shield.jpg" alt="Image of the motor shield" style="
	margin-right: auto;
	margin-left: auto;
	width: 100%;
	"
...
<img src="{{ site.baseurl }}/assets/images/vacuum_render_front.jpg" alt="Image of the vacuum box" style="
	margin-right: auto;
	margin-left: auto;
	width: 50%;
	"
...
<img src="{{ site.baseurl }}/assets/images/iso_render.jpg" alt="Image of the entire assembly" style="
	margin-right: auto;
	margin-left: auto;
	width: 70%;
	"
